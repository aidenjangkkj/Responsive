...
const Navbar = ({ id, backgroundColor }) => {
  ...
  return (
    <nav style={{ backgroundColor }} className="transition-all bg-white md:bg-inherit dark:bg-gray-900 fixed w-full z-20 top-0 start-0 dark:border-gray-600">
          ...
          <ul className="md:text-white transition-all mt-20 p-4 space-y-4 md:space-y-0 md:space-x-8 md:flex md:flex-row md:mt-0 md:p-0 md:bg-none dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 md:text-[1.875rem]">
            <li>
              <a
                ...
                onClick={()=> scrollToDiv("vision-section")}
              >
                비전
              </a>
            </li>
            <li>
              <a
                href="#sector1#business-section"
                className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text:white dark:hover:bg-gray-700 dark:hover:text:white md:dark:hover:bg-transparent dark:border-gray-700 md:text-white"
                onClick={()=> scrollToDiv("business-section")}
              >
                사업정보
              </a>
            </li>
            <li>
              <a
                href="#sector3#app-section"
                className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text:white dark:hover:bg-gray-700 dark:hover:text:white md:dark:hover:bg-transparent dark:border-gray-700 md:text-white"
                onClick={()=> scrollToDiv("app-section")}
              >
                공인APP
              </a>
            </li>
            <li>
              <a
                href="#sector3#certificate-section"
                className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text:white dark:hover:bg-gray-700 dark:hover:text:white md:dark:hover:bg-transparent dark:border-gray-700 md:text-white"
                onClick={()=> scrollToDiv("certificate-section")}
              >
                자격증센터
              </a>
            </li>
            <li>
              <a
                href="#sector3#mebership-section"
                className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text:white dark:hover:bg-gray-700 dark:hover:text:white md:dark:hover:bg-transparent dark:border-gray-700 md:text-white"
                onClick={()=> scrollToDiv("mebership-section")}
              >
                Membership
              </a>
            </li>
